...
\input{ads/code-highlighting-header.tex}
...
\lstdefinelanguage{Kotlin}{
    ...
    morekeywords=[2]{},
    morekeywords=[3]{moveToJointPose, toList, doubleArrayOf, map, get, asyncSendRequest, to, shouldBe, MoveListener, delay, createClient, createNode, rclJavaInit, motion2, motion1, generateMoveRequest, testMotionExecutionStates, testOverallStateToBe, testMoveRequest, hasAllMoveRobotResponseChecksProcessed, toLong, fixed, seconds, until, moveRobot, testMotion, IllegalArgumentException, invoke, poll, supervisorScope, launch},
    ...
    morestring=[b]",
    morestring=[s]{"""*}{*"""},
    ndkeywords={@Deprecated, @JvmField, @JvmName, @JvmOverloads, @JvmStatic, @JvmSynthetic, Array, DoubleArray, FloatArray, Byte, Double, Float, Int, Integer, Iterable, Long, Runnable, Short, String, Unit, Duration, RCLJava, GetCurrentTool, MoveResponse, TestContext, MoveRequest, TestClient, STARTED, STOPPED, FINISHED, EXECUTING, QUEUED, it, MoveJoint, MoveJoint_Request, MoveJoint_Response},
    ndkeywordstyle={\color{orange}\bfseries},
    sensitive=true,
    showstringspaces=false,
    keywordstyle=\color[rgb]{0.9,0.1,0.9},
    commentstyle=\color[rgb]{0.6,0.6,0.6},
    stringstyle=\color[rgb]{0.0,0.7,0.2}
}
